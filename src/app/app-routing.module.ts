...
import { GuardGuard } from './shared/gurds/guard.guard';
...
const routes: Routes = [
  ...
  {path: 'contAdmin', component:ContAdminComponent, canActivate:[GuardGuard]},
   ...
   { path: 'nuevoRadicado', loadChildren: () => import('./pages/radicado/nuevo-radicado/nuevo-radicado.module').then(m => m.NuevoRadicadoModule),canActivate:[GuardGuard] },
